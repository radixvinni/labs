...
s2 (
	...
	x1 = _mm_andnot_si128(a5, KCONST_1);
	x2 = _mm_andnot_si128(a1, KCONST_1);
	x3 = a5 ^ a6;
	x4 = x3 ^ x2;
	x5 = x4 ^ a2;
...
s3 (
	...
	aligned register KTYPE	x41, x42, x43, x44, x45, x46, x47, x48;
	aligned register KTYPE	x49, x50, x51, x52, x53, x54, x55, x56;
	aligned register KTYPE	x57;

	x1 = _mm_andnot_si128(a5, KCONST_1);
	x2 = _mm_andnot_si128(a6, KCONST_1);
	x3 = a5 & a3;
	x4 = x3 ^ a6;
	x5 = a4 & x1;
	x6 = x4 ^ x5;
...
s4 (
	...
	aligned register KTYPE	x25, x26, x27, x28, x29, x30, x31, x32;
	aligned register KTYPE	x33, x34, x35, x36, x37, x38, x39, x40;
	aligned register KTYPE	x41, x42;

	x1 = _mm_andnot_si128(a1, KCONST_1);
	x2 = _mm_andnot_si128(a3, KCONST_1);
	x3 = a1 | a3;
	x4 = a5 & x3;
	x5 = x1 ^ x4;
	x6 = a2 | a3;
	...
	x24 = x13 ^ x23;
	*out2 ^= x24;
	x25 = _mm_andnot_si128(x13, KCONST_1);
	x26 = a6 | x22;
	x27 = x25 ^ x26;
	*out1 ^= x27;
	x28 = a2 & x11;
...
s5 (
	...
	aligned register KTYPE	x41, x42, x43, x44, x45, x46, x47, x48;
	aligned register KTYPE	x49, x50, x51, x52, x53, x54, x55, x56;
	aligned register KTYPE	x57, x58, x59, x60, x61, x62;

	x1 = _mm_andnot_si128(a6, KCONST_1);
	x2 = _mm_andnot_si128(a3, KCONST_1);
	x3 = x1 | x2;
	x4 = x3 ^ a4;
	x5 = a1 & x3;
	...
	x12 = a5 & x11;
	x13 = x6 ^ x12;
	x14 = _mm_andnot_si128(x4, KCONST_1);
	x15 = x14 & a6;
	x16 = a1 | x15;
	x17 = x8 ^ x16;
	x18 = a5 | x17;
	...
	*out3 ^= x21;
	...
	x30 = x26 ^ x29;
	x31 = a4 | x27;
	x32 = _mm_andnot_si128(x31, KCONST_1);
	x33 = a2 | x32;
	x34 = x30 ^ x33;
	*out2 ^= x34;
	x35 = x2 ^ x15;
...
s6 (
	...
	x1 = _mm_andnot_si128(a2, KCONST_1);
	x2 = _mm_andnot_si128(a5, KCONST_1);
	x3 = a2 ^ a6;
	x4 = x3 ^ x2;
	x5 = x4 ^ a1;
	x6 = a5 & a6;
	...
	*out2 ^= x22;
	...
	x28 = a4 & x27;
	x29 = x25 ^ x28;
	x30 = _mm_andnot_si128(x26, KCONST_1);
	x31 = a6 | x29;
	x32 = _mm_andnot_si128(x31, KCONST_1);
	x33 = a4 & x32;
	x34 = x30 ^ x33;
...
s8 (
	...
	aligned register KTYPE	x33, x34, x35, x36, x37, x38, x39, x40;
	aligned register KTYPE	x41, x42, x43, x44, x45, x46, x47, x48;
	aligned register KTYPE	x49, x50, x51, x52, x53, x54;

	x1 = _mm_andnot_si128(a1, KCONST_1);
	x2 = _mm_andnot_si128(a4, KCONST_1);
	x3 = a3 ^ x1;
	x4 = a3 | x1;
	x5 = x4 ^ x2;
	x6 = a5 | x5;
	...
	*out1 ^= x21;
	x22 = a5 | x3;
	x23 = x22 & x2;
	x24 = _mm_andnot_si128(a3, KCONST_1);
	x25 = x24 & x8;
	x26 = a5 & x4;
	x27 = x25 ^ x26;
	x28 = a2 | x27;
	...
	*out3 ^= x44;
	x45 = a1 ^ x10;
	x46 = x45 ^ x22;
	x47 = _mm_andnot_si128(x7, KCONST_1);
	x48 = x47 & x8;
	x49 = a2 | x48;
	x50 = x46 ^ x49;
	x51 = x19 ^ x29;
